...
try {
    ...
    // Example query
    $query = "UPDATE `tblstudents` SET `firstName`='$firstName',`lastName`='$lastName',`email`='$email',`phoneNumber`='$mobile',`regNumber`='$regNumber',`username`='$username',`password`='$password' WHERE `stu_id`= $stu_id ";
