        ...
        <div id="layoutSidenav_content">
            <main>
                ...
                myForm.addEventListener("submit", function(e) {
                    ...
                    if (othername != "" && hasNumbersOrSymbols(othername)) {
                        othernameErr.textContent = "Please only aphabetical character is allowed!";
                        isTrue = false;
                    }
                    ...
                    if (password != "") {
                        if (password.length < 6) {
                            ...
                            confirmpwdErr.textContent = "password did not match";
                            isTrue = false;
                        }
